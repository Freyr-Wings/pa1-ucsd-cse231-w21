...
// import { Expr, FuncBody, FuncDef, PreDef, Program, Stmt, TypedVar, VarDef, Type, Literal, VarName, Variable, Value, ImportObject } from "./ast";
// import { Env, envManager } from "./env";
// import { parse } from "./parser";
// import { tcProgram, tcExpr } from "./typechecker"
...
// let memorySizeByte = 0;

// export function compile(source: string, importObject: ImportObject) : CompileResult {
//   const ast = parse(source);
//   console.log(ast);
//   tcProgram(ast);
//   console.log(curEnv);

//   memorySizeByte = importObject.js.mem.buffer.byteLength;
//   importObject.imports = {
//     print_obj: (ptr: number) => {
//       // TODO: set the function to object's dispatch table
//     },

//     print_int: (ptr: number) => {
//       // TODO: set the function to int's dispatch table
//     },

//     print_bool: (ptr: number) => {
//       // TODO: set the function to bool's dispatch table
//     },
...
//   let resultValue: Value = {tag: "none"};
...
//       if (lastExpr.type.name == "int") {
//         // TODO
//       } else if (lastExpr.type.name == "bool") {
//         // TODO
//       } else {
//         // TODO
//       }
...
//   if (!initialized) {
//     initWASM = 
//       updateGeneralPointerWithOffset("SP", -(memorySizeByte / 4 - 2)).join("\n") + "\n" +
//       updateGeneralPointerWithOffset("DL", -(memorySizeByte / 4 - 1)).join("\n");
//     initialized = true;
//   }
